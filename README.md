...
Supports Clojure 1.10 or later, Babashka 1.13.222 or later, and Jolt 0.8.8 or later.
...
{:aliases {:rephrase-nrepl-middleware 
           {:extra-deps {org.corfield/rephrase {:mvn/version "1.0.6"}}
